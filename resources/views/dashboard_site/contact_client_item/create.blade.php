            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('contact_client.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @enderror
                                        <img class="hidden mt-2" id="contact_photo_viewer" style="width: 100px;height:auto;" src="#" alt="your image" /><br>
    ...
    <script>
        ...
        function readURL(input) {
            if (input.files && input.files[0]) {
                ...
                $('#contact_photo_viewer').attr('src', e.target.result).width(150).height(195);
                };
                $('#contact_photo_viewer').removeClass('hidden');
